/**
 *  Copyright (C) 2020 www.linkinip.com Inc. All rights reserved.
 * 
 * 
 *               			  _ooOoo_
 *                			 o8888888o
 ...
 *         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
 *                         佛祖保佑       永无BUG 
 * 			created on 2020年5月24日 下午3:44:07  by rico
 */
 ...
 * 
 * @author rico
 * @date 2020年5月24日 下午3:44:07
 */
public class CommentGen implements CommentGenerator {
	...
	protected void addJavadocTag(JavaElement javaElement, boolean markAsDoNotDelete) {
		/*
		 * javaElement.addJavaDocLine(" *"); //$NON-NLS-1$ StringBuilder sb = new
		 * StringBuilder(); sb.append(" * "); //$NON-NLS-1$
